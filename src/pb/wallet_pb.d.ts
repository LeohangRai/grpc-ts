...
export class CreateAddressResponse extends jspb.Message { 
    getAddress(): string;
    setAddress(value: string): CreateAddressResponse;
...
export class TransactionRequest extends jspb.Message { 
    getToaddress(): string;
    setToaddress(value: string): TransactionRequest;
    getPoints(): number;
    setPoints(value: number): TransactionRequest;
    getMetadata(): string;
    setMetadata(value: string): TransactionRequest;
...
export class TransactionResponse extends jspb.Message { 
    ...
    setTransactionId(value: number): TransactionResponse;
...
export class BalanceResponse extends jspb.Message { 
    getTotal(): number;
    setTotal(value: number): BalanceResponse;
    getAvailable(): number;
    setAvailable(value: number): BalanceResponse;
...
export class WalletInfoRequest extends jspb.Message { 
    getAddress(): string;
    setAddress(value: string): WalletInfoRequest;
...
export class WalletInfoResponse extends jspb.Message { 
    getTotal(): number;
    setTotal(value: number): WalletInfoResponse;
    getAvailable(): number;
    setAvailable(value: number): WalletInfoResponse;
    clearTransactionsList(): void;
    getTransactionsList(): Array<Transaction>;
    setTransactionsList(value: Array<Transaction>): WalletInfoResponse;
...
export class Transaction extends jspb.Message { 
    ...
    getPoints(): number;
    setPoints(value: number): Transaction;
    getMetadata(): string;
    setMetadata(value: string): Transaction;
